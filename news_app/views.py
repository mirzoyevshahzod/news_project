...
def news_detail(request , news):
    ...
    if request.method == "POST":
        ...
        if comment_form.is_valid():
            #yangi komment modelini yaratamiz lekin MBga yuklamaymiz

            new_comment = comment_form.save(commit=False)
            new_comment.news = news

            #Izoh egasini request yuborayotgan userga boglaymiz
...
def homePageView(request):                #Funksiya orqali homepageview
...
class HomePageView(ListView):   #class orqali home page view
    model = News
